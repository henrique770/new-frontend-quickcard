...
class CardEntity extends  BaseEntity {
  ...
  constructor(args = {}) {
    ...
    this.ColumnsMapper  = ['Verse','Front', 'IdDeck','DateLastView','DateNextView'
                            ,'NumDifficultCount','NumEasyCount','NumGoodCount'
                            ,'IsReviewed','BaseHours','CodEnumHit','DisplayDeadline']
  }
   ...
   * @returns {string}
   */
  get IdDeck() { return this._idDeck }
  set IdDeck(value) { this._idDeck = value }
